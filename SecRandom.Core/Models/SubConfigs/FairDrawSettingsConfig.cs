...
public partial class FairDrawSettingsConfig : ObservableObject
{
    ...
    [ObservableProperty] private bool _enableAvgGapProtection;

    [ObservableProperty] private bool _enableBehindSceneSettings;
    ...
    [ObservableProperty] private bool _fairDrawTime; // 时间
