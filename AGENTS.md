...
- File/data paths should go through `Utils.GetFilePath(...)`; regardless of installation or portable deployment, mutable data must remain under the application package root's `data/` directory. Do not redirect data to system or user-profile locations.
