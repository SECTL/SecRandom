...
- Mobile UI, language, backup, and telemetry conventions (component library, theme dictionaries, animation primitives, culture reload, StorageProvider archive flows, Sentry wiring) are documented in `SecRandom.Mobile.Shared/AGENTS.md`; keep mobile-specific rules there instead of duplicating them here.
